...
const App = () => {
  ...
  const handleGeneratePassword = () => {
    if (!includeUpperCase && !includeLowerCase && !includeNumbers && !includeSymbols) {
      notify("centang dulu checkbox nya biar bisa diproses", true)
    }
    else {
      let characterList = ""
      if (includeNumbers) {
      ...
      notify("Password Berhasil Dibuat Oke Salin Aja Gas", false)
    }
      ...
      <div className="container">
        <div className="generator">
          ...
          <div className="form-group">
            <label htmlFor="password-strength">Panjang Passwordnya</label>
          ...
          <div className="form-group">
            <label htmlFor="include-numbers">Tambah Nomer</label>
